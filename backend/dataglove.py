...
class MPU6050:
    def __init__(self):
        ...
        self.gpio_leds = [19, 21] #19: yellow; 21: green
        self.gpio_array = [15, 13, 11, 33, 31, 29, 8, 37, 35, 22, 18, 16, 38, 36, 32, 12] #[15, 13, 11] -> MCP, PIP and DIP for Little Finger... [12] -> wrist 
    ...
    def calibration(self):
        ...
        while index < self.gpio_array_qtd:
            ...
            index+=1
        GPIO.output(self.gpio_leds[1], GPIO.HIGH)
